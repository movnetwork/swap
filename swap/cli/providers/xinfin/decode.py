...
from ....providers.xinfin.utils import decode_transaction_raw


@click.command("decode", options_metavar="[OPTIONS]",
               short_help="Select XinFin Transaction raw decoder.")
@click.option("-tr", "--transaction-raw", type=str, required=True, help="Set XinFin transaction raw.")

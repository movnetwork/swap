...
class NormalTransaction(Transaction):
    ...
    def sign(self, solver: NormalSolver) -> "NormalTransaction":
        ...
        >>> normal_transaction: NormalTransaction = NormalTransaction(network="mainnet")
        >>> normal_transaction.build_transaction(address=sender_wallet.address(), recipients={"vp1qf78sazxs539nmzztq7md63fk2x8lew6ed2gu5rnt9um7jerrh07qcyvk37": 10000000}, asset="ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff")

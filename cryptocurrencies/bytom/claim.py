...
print("Unsigned Claim Transaction Fee:", unsigned_claim_transaction.fee(symbol="NEU"), "NEU")
...
print("Signed Claim Transaction Fee:", signed_claim_transaction.fee(symbol="NEU"), "NEU")
...
print("Claim Signature Fee:", claim_signature.fee(symbol="NEU"), "NEU")
